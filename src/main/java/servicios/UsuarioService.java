...
public class UsuarioService {
	...
	public Usuario create(String nombre, double presupuesto, double tiempo_disponible, String username, String password, Boolean admin) {
		Usuario user = new Usuario(-1, nombre, presupuesto, tiempo_disponible, password, "invitado");
...
//	public Usuario update(Integer id, String nombre, double presupuesto, double tiempo_disponible, String username, String password, Boolean rol) {
//
